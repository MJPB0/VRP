...
public class Sliceable : MonoBehaviour
{
    ...
    public float getForceAppliedToCut() { return _forceAppliedToCut; }
    public float getDissapearTime() { return _dissapearTime; }
    public bool WillDissapear() { return _willDissapear; }
